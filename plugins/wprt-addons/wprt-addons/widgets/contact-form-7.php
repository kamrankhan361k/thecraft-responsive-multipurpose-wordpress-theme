...
class WPRT_cf7 extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_cf7',
            esc_html__( 'Contact Form 7', 'thecraft' ),
            array(
                'classname'   => 'widget_cf7',
                'description' => esc_html__( 'Display Contact Form 7 for Widgets.', 'thecraft' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'texts' ) ); ?>"><?php esc_html_e('Some Texts:', 'thecraft') ?></label>
        ...
        <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'form' ) ); ?>"><?php esc_html_e( 'Form:', 'thecraft' ); ?></label>
        <?php
...
add_action( 'widgets_init', 'register_wprt_cf7' );

// Register widget
function register_wprt_cf7() {
