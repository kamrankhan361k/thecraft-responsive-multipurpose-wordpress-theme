...
class WPRT_Spacer extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_spacer',
            esc_html__( 'Empty Space', 'thecraft' ),
            array(
                'classname'   => 'widget_spacer',
                'description' => esc_html__( 'Blank space with custom height.', 'thecraft' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id( 'desktop' ) ); ?>"><?php esc_html_e( 'Desktop screen:', 'thecraft' ); ?></label>
        ...
        <p><label for="<?php echo esc_attr( $this->get_field_id( 'mobi' ) ); ?>"><?php esc_html_e( 'Mobile screen:', 'thecraft' ); ?></label>
...
add_action( 'widgets_init', 'register_wprt_spacer' );

// Register widget
function register_wprt_spacer() {
