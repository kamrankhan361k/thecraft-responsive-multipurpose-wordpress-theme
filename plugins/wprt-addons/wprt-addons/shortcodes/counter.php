...
if ( $number )
	...
	$number_html .= sprintf(
	'<div class="number-wrap font-heading" style="%2$s"><span class="prefix %10$s" style="%3$s">%5$s</span><span class="number %9$s" data-speed="%7$s" data-from="0" data-to="%8$s"> %1$s</span><span class="suffix %11$s" style="%4$s">%6$s</span></div>',
	$number,
	$number_css,
	$prefix_css,
	$suffix_css,
